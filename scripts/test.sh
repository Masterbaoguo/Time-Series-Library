...
python -u run.py  --task_name long_term_forecast  --is_training 0  --root_path ./dataset/btc/  --data_path btc-2024-01-01.csv  --model_id BTCm1_96_96  --model PatchTST  --data BTC  --features M  --seq_len 96  --label_len 48  --pred_len 96  --e_layers 1  --d_layers 1  --factor 3  --enc_in 5  --dec_in 5  --c_out 5  --des 'Exp'  --n_heads 2  --batch_size 32  --itr 1


python -u run.py  --task_name long_term_forecast  --is_training 1  --root_path ./dataset/ETT-small/  --data_path ETTm1.csv  --model_id ETTm1_96_96  --model PatchTST  --data ETTm1  --features M  --seq_len 96  --label_len 48  --pred_len 96  --e_layers 1  --d_layers 1  --factor 3  --enc_in 7  --dec_in 7  --c_out 7  --des 'Exp'  --n_heads 2  --batch_size 32  --itr 1